...
enum GatewayEnvironment {
    ...
    static func gatewayPort() -> Int {
        if let raw = OpenClawEnv.environment["OPENCLAW_GATEWAY_PORT"] {
    ...
    static func expectedGatewayVersionString() -> String? {
        if let version = OpenClawEnv.string("OPENCLAW_VERSION") {
            return version
        }
    ...
    private static func preferredGatewayBind() -> String? {
        ...
        if let env = OpenClawEnv.environment["OPENCLAW_GATEWAY_BIND"] {
